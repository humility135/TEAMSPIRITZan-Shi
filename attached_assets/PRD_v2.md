...
| **(v2 新增) Lite 月費** | **$28/月** | 5 隊上限；Admin 開收費活動**唔再扣 1 Token / 次**（成本包月費）；無雷達圖、無客製主題 | 中量級隊長 |
| **Pro 月費** | $78/月 | 20 隊上限 + Lite 全部 + **平台抽成 0%**（vs 一般 5%）+ 雷達圖 + 客製化 Logo / 主題色 / 去水印 + 每月 1 張 Welcome Match 試踢券（送新人免費試踢一場） | 多隊領隊 / 認真經營球隊 |
...
> **典型 Owner**（管 1 隊、每月 4 場收費活動 × $50 × 14 人）
> - 創隊：2 Tokens / 30 日
> - 舉辦收費活動：4 Tokens / 月
> - **每月燒：6 Tokens ≈ $12**（以 $20/10 換算）
> - 平台抽成：$50 × 14 × 4 × 5% = **$140 / 月**
> - **總成本：$152 / 月**
> - 結論：升 **Pro $78** 立即省返 $74（Pro 抽成 0%、活動免扣 Token）→ 強誘因

> **中量級 Admin**（管 2 隊、每月 2 場免費 + 2 場收費）
> - 加入 + 創立 2 隊：4 Tokens / 30 日
> - 收費活動：2 Tokens / 月
> - **每月燒：6 Tokens ≈ $12** + 抽成 ~$70
> - 結論：**Lite $28 + 抽成 $70 = $98**，比 Pro $78 仲貴 → 應該升 Pro

> **重度球員**（踢 4 隊、其中 2 隊收費）
> - 加入 4 隊：4 Tokens / 30 日
> - **每月燒：4 Tokens ≈ $8**
> - Token 模式仲化算，不必升月費（球員端冇月費 plan）

→ 經濟線設計使**任何月開 ≥ 4 場收費活動嘅 Admin 都會自動爬升至 Pro**，月費收入可預測。
...
### 5.3 平台抽成 — 釐清誰付
- **Stripe / PayMe**：平台抽 **5%**（**Pro Admin 0%**），由**球員付**（價格上加 5%，例如報名費 $50 → 球員實付 $52.5）
- **FPS 手動**：平台**唔抽**（無金流），但 Admin 仍需 1 Token / 活動（Lite / Pro 月費包）
