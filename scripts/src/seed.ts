...
async function main() {
  ...
  await db.insert(usersTable).values([
    { id: "u1", email: "ahfai@example.com", googleId: "g1", name: "Ah Fai", avatarUrl: "https://i.pravatar.cc/150?u=u1",
    ...
    { id: "u2", email: "kitc@example.com", googleId: "g2", name: "Kit C.", avatarUrl: "https://i.pravatar.cc/150?u=u2",
      tokensBalance: 10, subscription: "free",
      seasonStatsByTeam: { t1: { goals: 2, assists: 15, attendance: 90, yellow: 1, red: 0, matches: 22 } } },
    { id: "u3", email: "ming@example.com", googleId: "g3", name: "Ming", avatarUrl: "https://i.pravatar.cc/150?u=u3",
